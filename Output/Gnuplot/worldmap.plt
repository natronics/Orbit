...
set terminal png truecolor size 1280, 1280
...
"./Output/out.dat" every 100 us ($2/1000.0):($3/1000.0):($4/1000.0) w lines linestyle 5
...
"./Output/MapData/rivers.map" every 150 us (f($1,$2)):(g($1,$2)):(h($1,$2)) w lines linestyle 2, \
"./Output/MapData/countries-us.map" every 40 us (f($1,$2)):(g($1,$2)):(h($1,$2)) w lines linestyle 3, \
"./Output/out.dat" every 110 us ($2/1000.0):($3/1000.0):($4/1000.0) w lines linestyle 5
...
"./Output/out.dat" us 15:14 w points linestyle 5
